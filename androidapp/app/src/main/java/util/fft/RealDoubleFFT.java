...
public class RealDoubleFFT extends RealDoubleFFT_Mixed {
	 ...
	 * computed and stored.
	 *
	 * @param n the size of a real data sequence. When <em>n</em> is a
	 ...
	 * data sequence.
	 *
	 * @param x an array which contains the sequence to be transformed. After
	 ...
	 *          FFT, <em>x</em> contains the transform coeffients used to
	 *          construct <em>n</em> complex FFT coeffients. <br>
	 * @param y the first complex (<em>n</em>+1)/2 (when <em>n</em> is odd) or
	 ...
	 *
	 * @param x an array which contains the sequence to be transformed. When
	 *          <em>n</em> is odd, it contains the first (<em>n</em>+1)/2
	 *          complex data; when <em>n</em> is even, it contains (<em>n</em>
	 *          /2+1) complex data.
	 * @param y the real FFT coeffients. <br>
